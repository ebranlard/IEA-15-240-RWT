...
---------------------- INPUT FILES ---------------------------------------------
"ED_V.2.2.dat"         EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
"IEA-15-240-RWT_BeamDyn.dat"    BDBldFile(1) - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"IEA-15-240-RWT_BeamDyn_NoOut.dat"    BDBldFile(2) - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"IEA-15-240-RWT_BeamDyn_NoOut.dat"    BDBldFile(3) - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
